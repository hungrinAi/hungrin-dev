        ...
        "Orders.useEffect": ()=>{
            if (summary === null || summary === void 0 ? void 0 : summary.orders) {
                const ids = summary.orders.filter({
                    "Orders.useEffect.ids": (o)=>o.status === 'completed'
                }["Orders.useEffect.ids"]).map({
                    "Orders.useEffect.ids": (o)=>o.id
                }["Orders.useEffect.ids"]);
...
_s(Orders, "McJobyhRU3oMiz7+ZRr0pdKyrac=", false, function() {
    return [
...
//# sourceMappingURL=src_73d76d35._.js.map