...
"[project]/src/features/dashboard/api.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/dashboard/hooks/useDashboard.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/api.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
;
;
function useDashboard() {
    _s();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApi"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dashboardApi"].getStats);
}
_s(useDashboard, "YdXwqDVp/2jyPTcf46wQe16nqmk=", false, function() {
    return [
...
"[project]/src/features/dashboard/hooks/useSalesChart.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useSalesChart(stats) {
    var _stats_salesDataByPeriod, _chartData_;
    _s();
    const [activePeriod, setActivePeriod] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('This Week');
    var _stats_salesDataByPeriod_activePeriod, _ref;
    const chartData = (_ref = (_stats_salesDataByPeriod_activePeriod = stats === null || stats === void 0 ? void 0 : (_stats_salesDataByPeriod = stats.salesDataByPeriod) === null || _stats_salesDataByPeriod === void 0 ? void 0 : _stats_salesDataByPeriod[activePeriod]) !== null && _stats_salesDataByPeriod_activePeriod !== void 0 ? _stats_salesDataByPeriod_activePeriod : stats === null || stats === void 0 ? void 0 : stats.salesData) !== null && _ref !== void 0 ? _ref : [];
    const totalSales = chartData.reduce((sum, d)=>sum + d.sales, 0);
    var _chartData__sales;
    const todaySales = (_chartData__sales = (_chartData_ = chartData[chartData.length - 1]) === null || _chartData_ === void 0 ? void 0 : _chartData_.sales) !== null && _chartData__sales !== void 0 ? _chartData__sales : 0;
    return {
        activePeriod,
        setActivePeriod,
        chartData,
...
_s(useSalesChart, "BZ/N0dLB6+zYhFZNWXmz8bfcJnM=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/features/dashboard/data/constants.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/dashboard/hooks/useAiChat.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$data$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/data/constants.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
;
;
function getMockReply(input) {
    const lower = input.toLowerCase();
    const match = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$data$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AI_RESPONSES"].find((param)=>{
        let { keywords } = param;
        return keywords.some((k)=>lower.includes(k));
    });
    var _match_reply;
    return (_match_reply = match === null || match === void 0 ? void 0 : match.reply) !== null && _match_reply !== void 0 ? _match_reply : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$data$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_AI_REPLY"];
}
function useAiChat() {
    _s();
    ...
    const send = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAiChat.useCallback[send]": (text)=>{
            const message = (text !== null && text !== void 0 ? text : input).trim();
            if (!message) return;
            const userMsg = {
            ...
            setMessages({
                "useAiChat.useCallback[send]": (prev)=>[
                        ...prev,
                        userMsg
                    ]
            }["useAiChat.useCallback[send]"]);
            setInput('');
            setIsTyping(true);
            setTimeout({
                "useAiChat.useCallback[send]": ()=>{
            ...
            }["useAiChat.useCallback[send]"], 900);
        }
    }["useAiChat.useCallback[send]"], [
        input
    ]);
    const sendSuggestion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAiChat.useCallback[sendSuggestion]": (suggestion)=>{
            send(suggestion);
        }
    }["useAiChat.useCallback[sendSuggestion]"], [
        send
    ]);
    return {
        messages,
...
_s(useAiChat, "RofHCk4BxntXeW+ezbPk+5aRkjg=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/features/dashboard/hooks/useBoostPromo.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useBoostPromo() {
    ...
    const [activeDuration, setActiveDuration] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Day');
    ...
    const open = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBoostPromo.useCallback[open]": ()=>{
            setConfirmed(false);
            setIsOpen(true);
        }
    }["useBoostPromo.useCallback[open]"], []);
    const close = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBoostPromo.useCallback[close]": ()=>setIsOpen(false)
    }["useBoostPromo.useCallback[close]"], []);
    const togglePlatform = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBoostPromo.useCallback[togglePlatform]": (p)=>{
            setSelectedPlatforms({
                "useBoostPromo.useCallback[togglePlatform]": (prev)=>prev.includes(p) ? prev.filter({
                        "useBoostPromo.useCallback[togglePlatform]": (x)=>x !== p
                    }["useBoostPromo.useCallback[togglePlatform]"]) : [
                        ...prev,
                        p
                    ]
            }["useBoostPromo.useCallback[togglePlatform]"]);
    ...
    const confirm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBoostPromo.useCallback[confirm]": ()=>{
            setConfirmed(true);
        }
    }["useBoostPromo.useCallback[confirm]"], []);
    return {
        ...
        confirmed,
        confirm,
        ALL_PLATFORMS: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$data$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ALL_PLATFORMS"],
        DURATIONS: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$data$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DURATIONS"]
    };
}
_s(useBoostPromo, "Ymur77x50RvDwPLuEJ+ST5nGmqo=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/features/dashboard/components/StatsGrid.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StatsGrid(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$data$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATS_CARDS"].map((card)=>{
            var _stats_card_key;
...
"[project]/src/features/dashboard/components/SalesChart.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useSalesChart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/hooks/useSalesChart.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
;
;
function SalesChart(param) {
    let { stats } = param;
    _s();
    const { activePeriod, setActivePeriod, chartData, totalSales, todaySales, PERIODS } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useSalesChart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSalesChart"])(stats);
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: PERIODS.map((t)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: ()=>setActivePeriod(t),
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('px-4 py-1.5 rounded-lg text-xs font-semibold border transition-all whitespace-nowrap', activePeriod === t ? 'bg-white border-border-light shadow-sm text-text-dark' : 'bg-g-faint border-transparent text-text-mid hover:bg-g-pale'),
                                    children: t
                                }, t, false, {
                                    fileName: "[project]/src/features/dashboard/components/SalesChart.tsx",
                                    lineNumber: 38,
...
_s(SalesChart, "uKOieVBQjTy4RxJzUtd0MDOvHOU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useSalesChart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSalesChart"]
    ];
});
_c = SalesChart;
var _c;
...
"[project]/src/features/dashboard/components/BoostPromoModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BoostPromoModal(param) {
    let { open, onClose, promo, selectedPlatforms, onTogglePlatform, activeDuration, onSetDuration, confirmed, onConfirm, allPlatforms, durations } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Modal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Modal"], {
        ...
        children: confirmed ? /* ── Success state ── */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                    ...
                                    children: promo === null || promo === void 0 ? void 0 : promo.title
                                }, void 0, false, {
                                    fileName: "[project]/src/features/dashboard/components/BoostPromoModal.tsx",
                                    lineNumber: 64,
                                    columnNumber: 15
            ...
            lineNumber: 57,
            columnNumber: 9
        }, this) : /* ── Configuration state ── */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "space-y-5",
            children: [
                promo && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: durations.map((d)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('flex-1 py-2 rounded-xl text-xs font-bold border transition-all', activeDuration === d ? 'bg-g-dark text-white border-g-dark shadow-sm' : 'bg-g-faint text-text-mid border-border-light hover:bg-g-pale'),
                                    children: d
                                }, d, false, {
                                    fileName: "[project]/src/features/dashboard/components/BoostPromoModal.tsx",
                                    lineNumber: 100,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: allPlatforms.map((p)=>{
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('flex items-center gap-2 px-3 py-2.5 rounded-xl border text-xs font-bold transition-all text-left', active ? 'bg-g-pale border-g-dark text-g-dark ring-1 ring-g-dark/20' : 'bg-white border-border-light text-text-mid hover:bg-g-faint'),
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "text-base",
...
_c = BoostPromoModal;
var _c;
__turbopack_context__.k.register(_c, "BoostPromoModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/features/dashboard/components/PromoCard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/Button.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useBoostPromo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/hooks/useBoostPromo.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$components$2f$BoostPromoModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/components/BoostPromoModal.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function PromoCard(param) {
    let { stats } = param;
    _s();
    const boost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useBoostPromo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBoostPromo"])();
    if (!(stats === null || stats === void 0 ? void 0 : stats.promoOfDay)) return null;
    ...
    var _activePlatformLabel_short;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: boost.open,
                                                        title: "Active: ".concat(boost.selectedPlatforms.join(', ')),
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('px-2 py-1 rounded text-[10px] font-bold transition-all', 'bg-g-dark text-white hover:bg-g-mid shadow-sm'),
                                                        children: (_activePlatformLabel_short = activePlatformLabel === null || activePlatformLabel === void 0 ? void 0 : activePlatformLabel.short) !== null && _activePlatformLabel_short !== void 0 ? _activePlatformLabel_short : 'G'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/features/dashboard/components/PromoCard.tsx",
                                                        lineNumber: 64,
                                                        columnNumber: 17
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        children: extraCount > 0 ? "+".concat(extraCount) : '+'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/features/dashboard/components/PromoCard.tsx",
                                                        lineNumber: 76,
                                                        columnNumber: 17
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: boost.open,
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('px-2 py-1 rounded text-[10px] font-bold border transition-all', 'bg-g-faint text-text-mid border-border-light hover:bg-g-pale'),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$components$2f$BoostPromoModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BoostPromoModal"], {
                open: boost.isOpen,
                onClose: boost.close,
...
_s(PromoCard, "RMOwn8JZmBqK7XjxtPAQFY5PmRo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useBoostPromo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBoostPromo"]
    ];
});
_c = PromoCard;
var _c;
...
"[project]/src/features/dashboard/components/AiAssistant.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useAiChat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/hooks/useAiChat.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function AiAssistant(param) {
    let { stats } = param;
    _s();
    const { messages, input, setInput, send, sendSuggestion, isTyping, bottomRef } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useAiChat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAiChat"])();
    const handleKey = (e)=>{
            ...
            messages.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    messages.map((msg)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('text-xs px-3 py-2 rounded-xl max-w-[90%] leading-relaxed', msg.role === 'user' ? 'bg-g-dark text-white self-end rounded-br-sm' : 'bg-white/80 text-text-dark self-start rounded-bl-sm border border-border-light shadow-sm'),
                            children: msg.text.split(/(\*\*[^*]+\*\*)/).map((part, i)=>part.startsWith('**') && part.endsWith('**') ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
...
_s(AiAssistant, "svPRG0ViO1ell3ExAqGXuzbFG84=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useAiChat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAiChat"]
    ];
});
_c = AiAssistant;
var _c;
...
__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useDashboard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/hooks/useDashboard.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useSalesChart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/hooks/useSalesChart.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useAiChat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/hooks/useAiChat.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useBoostPromo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/hooks/useBoostPromo.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$components$2f$StatsGrid$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/components/StatsGrid.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$components$2f$SalesChart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/components/SalesChart.tsx [app-client] (ecmascript)");
...
function Dashboard() {
    _s();
    const { data: stats, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useDashboard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboard"])();
...
_s(Dashboard, "y/xsU7RDbC22rOiJ3OytWUdY6aA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useDashboard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboard"]
    ];
});
_c = Dashboard;
var _c;
...
//# sourceMappingURL=src_34cea500._.js.map