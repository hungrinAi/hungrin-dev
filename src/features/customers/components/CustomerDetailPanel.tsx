  ...
  return (
    <>
      ...
      <SendPromoModal
        ...
        customer={customer}
        onConfirmed={() => addNotification({ type: 'success', title: 'Promo sent', message: `Promotion sent to ${customer.name} via SMS & email.` })}
      />
      <SendEmailModal
        open={showEmailModal}
        onClose={() => setShowEmailModal(false)}
        customer={customer}
        onConfirmed={() => addNotification({ type: 'success', title: 'Email sent', message: `Email sent to ${customer.name} (${customer.email}).` })}
      />
    </>
  );
}
