        ...
        <tbody className="divide-y divide-border-light">
          {orders?.map((o) => (
            <tr 
              ...
              className={cn("hover:bg-g-faint transition-colors cursor-pointer", selectedId === o.id ? "bg-g-pale" : "")}
            >
              ...
              <td className="px-4 py-4">
                <span className={cn(
                  ...
                  o.status === 'completed' ? "bg-g-pale text-g-dark" : "bg-yellow-50 text-yellow-700"
                )}>{o.status}</span>
              </td>
              <td className="px-4 py-4">
                <div className={cn(
